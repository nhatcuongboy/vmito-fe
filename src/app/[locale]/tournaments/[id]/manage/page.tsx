                ...
                <TabPanel>
                  <VStack align="stretch" gap={4}>
                    <Flex justify="space-between" alignItems="center">
                      ...
                      <NextLinkButton
                        href={`/tournaments/${tournamentId}/manage/categories/new`}
                        size="sm"
                          ...
                          <Card key={category.id} variant="outline">
                            <CardBody>
                              <VStack align="stretch" gap={3}>
                                ...
                                <NextLinkButton
                                  href={`/tournaments/${tournamentId}/manage/categories/${category.id}`}
                                  size="sm"
                                  variant="outline"
                                  w="full"
                                >
                ...
                <TabPanel>
                  <VStack align="stretch" gap={4}>
                    <Flex justify="space-between" alignItems="center">
                      ...
                      <NextLinkButton
                        href={`/tournaments/${tournamentId}/manage/players`}
                        size="sm"
                ...
                <TabPanel>
                  <VStack align="stretch" gap={4}>
                    <Flex justify="space-between" alignItems="center">
                      ...
                      <NextLinkButton
                        href={`/tournaments/${tournamentId}/manage/pairs`}
                        size="sm"

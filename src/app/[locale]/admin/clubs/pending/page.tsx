...
import { Check, X, Shield, MapPin, Users as UsersIcon, MessageSquare } from 'lucide-react';
...
const AdminClubApprovalPage = () => {
    ...
    return (
        <PageLayout title={t('clubs.adminApproval.title')}>
                            ...
                            <Flex gap={4}>
                                ...
                                >
                                    {club.image ? (
                                        ...
                                        <Flex w="full" h="full" align="center" justify="center" bg={club.color || 'green.500'}>
                                ...
                                <VStack align="start" flex={1} gap={2}>
                                    ...
                                    <HStack pt={2} fontSize="xs" color="gray.400">
                                        ...
                                        <Text fontWeight="medium" color="gray.600" _dark={{ color: 'gray.300' }}>
                                            {club.host.name}
                                        </Text>
                                    </HStack>
                                </VStack>
            ...
            >
                <Field label={t('clubs.rejectionReason', { reason: '' }).replace(': ', '')} required>
                    <Input

...
export default function HowItWorksSection() {
    ...
    const steps = [
        ...
        { icon: Search, title: t('steps.step2.title'), description: t('steps.step2.description') },
        { icon: Trophy, title: t('steps.step3.title'), description: t('steps.step3.description') },
    ];

...
const SessionShareCard = ({ session, mode = 'portrait' }: SessionShareCardProps) => {
        ...
        return (
            ...
            >
                <Grid templateColumns="450px 1fr" h="100%">
                    {/* Left: Image and QR */}
                    <Box bg="gray.50" borderRightWidth="2px" borderRightColor="gray.100" position="relative">
                        ...
                        <Box p={8} textAlign="center">
                            <Box bg="blue.600" color="white" py={4} px={6} mb={6} borderRadius="xl">
                            ...
                            <Flex align="center" justify="center" gap={6}>
                                ...
                                {qrDataUrl && (
                                    <Box p={2} border="1px solid" borderColor="gray.100" borderRadius="xl" bg="white">
                                ...
                                <Grid templateColumns="1fr 1fr" gap={10}>
                                    <Stack gap={6}>
                                        <Flex align="center" gap={4}>
                                            ...
                                            <Text fontSize="xl" fontWeight="semibold" color="gray.700">{compactDate}</Text>
                                        </Flex>
                                        <Flex align="center" gap={4}>
                                    ...
                                    <Stack gap={6}>
                                        <Flex align="center" gap={4}>
                                            ...
                                            <Text fontSize="xl" fontWeight="semibold" color="gray.700">{compactTime}</Text>
                                        </Flex>
                                        <Flex align="center" gap={4}>
                                    ...
                                    <Flex align="center" gap={4}>
                                        ...
                                        <Text fontSize="4xl" fontWeight="black" color="red.600">
                                            {session.feeConfig?.feeType === 'SPLIT_EVENLY' ? (
                                                session.feeConfig.splitPerPlayer ? FeeService.formatFee(session.feeConfig.splitPerPlayer) : 'Chia đều'
                                            ) : (
    ...
    return (
        ...
        >
            ...
            <Box p={4}>
                <Stack gap={3}>
                    {/* Title */}
                    <Heading size="lg" fontWeight="bold" color="gray.800" textAlign="center">
                        {session.name}
                    </Heading>
                    ...
                    <Stack gap={2}>
                        ...
                        <Grid templateColumns="1fr 1fr" gap={4}>
                            <Flex align="center" gap={2}>
                                ...
                                <Text fontSize="sm" fontWeight="medium" color="gray.700">{compactDate}</Text>
                            </Flex>
                            <Flex align="center" gap={2}>
                                <Icon as={Clock} boxSize={5} color="blue.500" />
                                <Text fontSize="sm" fontWeight="medium" color="gray.700">{compactTime}</Text>
                            </Flex>
                        </Grid>
                    ...
                    >
                        <Box flex="1">
                            <Text fontSize="sm" fontWeight="bold" color="blue.700" lineHeight="short" textAlign="center">
                                {t('shareCardFooter').split('VMITO.COM').map((part, index, array) => (
                                    <span key={index}>
                                        {part}
                                        {index < array.length - 1 && (
                                            <Text as="span" color="lime.500">VMITO.COM</Text>
                                        )}
                                    </span>
                                ))}
                            </Text>

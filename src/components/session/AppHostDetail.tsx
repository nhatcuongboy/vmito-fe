...
import { Card, CardHeader, CardBody, Button, VStack, HStack } from '@/components/ui/chakra-compat';
...
export const AppHostDetail = ({
    ...
    return (
        <Card w="full" maxW="400px" borderWidth={hideHeader ? "0" : "1px"} boxShadow={hideHeader ? "none" : "sm"}>
            {!hideHeader && (
                <CardHeader>
            ...
            <CardBody>
                <VStack gap={4} align="stretch">
                    ...
                    <Box>
                        ...
                        <UserRatingSummaryCard stats={stats} isLoading={loading} showBreakdown />
                    </Box>

...
import { ISessionFiltersProps, ISessionFilterState } from './SessionFilters.types';
...
const SessionFilters: React.FC<ISessionFiltersProps> = ({
    ...
    const handleFilterChange = (key: keyof ISessionFilterState, value: string | number | undefined) => {
        setFilters((prev) => ({
            ...prev,
            [key]: value,
        }));
                ...
                {showLevelFilter && (
                    <Box flex={{ base: '1 1 100%', lg: '0 1 180px' }}>
                        <Select
                            ...
                            onChange={(e) => handleFilterChange('level', e.target.value ? Number(e.target.value) : undefined)}
